        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "User's date of birth"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "JShip identificator")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SendDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date and time of sending"),
                    SenderId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Id of the user who sent the JShip"),
                    ReceiverId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Id of the user who was sent the JShip"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "JInvitation identificator")
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendShips_WithdrawnById",
                table: "FriendShips",
