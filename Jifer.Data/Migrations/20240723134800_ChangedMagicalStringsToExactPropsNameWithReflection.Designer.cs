...
namespace Jifer.Data.Migrations
{
    ...
    [Migration("20240723134800_ChangedMagicalStringsToExactPropsNameWithReflection")]
    partial class ChangedMagicalStringsToExactPropsNameWithReflection
    {
            ...
            modelBuilder.Entity("Jifer.Data.Models.JShip", b =>
                {
                    ...
                    b.Property<string>("WithdrawnById")
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Id of the user who withdrew the JShip");
            ...
            modelBuilder.Entity("Jifer.Data.Models.JShip", b =>
                {
                    ...
                    b.HasOne("Jifer.Data.Models.JUser", "WithdrawnBy")
                        .WithMany("WithdrawnFriendRequests")
            ...
            modelBuilder.Entity("Jifer.Data.Models.JUser", b =>
                {
                    ...
                    b.Navigation("WithdrawnFriendRequests");
                });
